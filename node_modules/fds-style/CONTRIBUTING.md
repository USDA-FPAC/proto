...
One of our goals is to ensure a welcoming environment for all contributors to our projects. Our staff follows the [FPAC Employee Responsibilities and Conduct](http://www.fds.usda.gov/FSA/hrdapp?area=home&subject=labr&topic=erc), and all contributors should do the same.
...
1. Fork this repo into your GitHub account (or just clone it if you're a member of the FPAC , nee USDA-FPAC, GitHub Organization). Read more about [forking a GitHub repository](https://help.github.com/articles/fork-a-repo).
...
1. Submit your pull request against the [gh-pages-dev](https://github.com/USDA-FPAC/fpac-design-system/tree/gh-pages-dev) branch.
